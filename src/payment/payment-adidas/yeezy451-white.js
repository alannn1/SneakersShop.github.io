...
import imgPay1 from '../../component/image/adidas/slider11.jpg'
import imgPay2 from '../../component/image/adidas/slider11.1.jpg'
import imgPay3 from '../../component/image/adidas/slider11.2.jpg'
import imgPay4 from '../../component/image/adidas/slider11.3.jpg'
    ...
    return (
        <div>
            ...
            <div>
                <aside className='asidePayment'>
                    ...
                    <div className='thumbnail-container'>
                        {[imgPay1, imgPay2, imgPay3, imgPay4].map((img, idx) => (
                            <img
                                key={idx}
                                src={img}
                                alt={`Thumbnail ${idx + 1}`}
            ...
            <div className='contentPaymentNb'>
                <hr />
                <div className='Judul'>
                    <p className='text-danger'>Adidas</p>
                    <p style={{fontSize:'35px'}}>Yeezy 451 Cloud White</p>
                    <p style={{fontSize:'18px', marginTop:'-20px'}}>Unisex</p>
                    <p style={{fontSize:'18px'}}>Rp. 10.550.000</p>
                </div>
                ...
                <div className='Size'>
                    ...
                    <Button variant='outline-dark' className={`btnSize ${isActive === 9 ? 'activebtn' : ''}`} disabled>EU 46</Button>
