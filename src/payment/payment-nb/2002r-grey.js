...
import imgPay1 from '../../component/image/nb/slide_nb2.jpg'
import imgPay2 from '../../component/image/nb/slide_nb2.1.jpg'
import imgPay3 from '../../component/image/nb/slide_nb2.2.jpg'
import imgPay4 from '../../component/image/nb/slide_nb2.3.jpg'
import imgPay5 from '../../component/image/nb/slide_nb2.4.jpg'
    ...
    return(
        <div>
            ...
            <div className='contentPaymentNb'>
                <hr />
                <div className='Judul'>
                    <p className='text-danger'>New Balance</p>
                    <p style={{fontSize:'35px'}}>550 White Black</p>
                    <p style={{fontSize:'18px', marginTop:'-20px'}}>Unisex</p>
                    <p style={{fontSize:'18px'}}>Rp. 2.550.000</p>
                </div>
